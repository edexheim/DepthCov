...
from depth_cov.nn.layers import BaseConv, DownConv, UpConv, ResidualConv

class UNet(nn.Module):
  def __init__(self, num_levels, in_channels, 
      base_feature_channels, feature_channels, 
    ...
    self.base = ResidualConv(in_channels, base_feature_channels, kernel_size, padding, stride)
  ...
  # TODO: Generalize number of levels
  def forward(self, x):
